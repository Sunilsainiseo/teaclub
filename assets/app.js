...
document.addEventListener('DOMContentLoaded', function () {
  ...
  $('body').on(w3elem, '[data-reset-filters]', () => {
    window.collectionSidebarFilter.clearAllFilters();
  });
  $('body').on(w3elem, '[data-clear-filter]', e => {
  ...
  $('body').on(w3elem, '.sidebar .parent-link--false', function (e) {
    e.preventDefault();
  ...
  window.utils.createAccordion('.footer_menu', 'h3', 'ul');
  window.utils.createAccordion('.footer_content', 'h3', 'div.toggle_content');
  ...
  $('body').on(w3elem, '.menu-toggle', function () {
  ...
  if (window.PXUTheme.theme_settings.display_tos_checkbox) {
    $('body').on(w3elem, '.cart_content .tos_label', function () {
  ...
  if (window.PXUTheme.theme_settings.display_tos_checkbox && window.PXUTheme.theme_settings.go_to_checkout) {
    ...
    $('body').on(w3elem, '.tos_warning [data-cart-checkout-button]', function (e) {
    ...
    $('body').on(w3elem, '.cart_content [data-minicart-checkout-button]', e => {
      // Redirect to cart page
      e.preventDefault();
      document.location.href = window.PXUTheme.routes.cart_url;
    });
  ...
  $('body').on(w3elem, '[data-remove-item]', function (e) {
    e.preventDefault();
    const cartItem = {
      lineID: $(this).parents('[data-cart-item]').data('line-id'),
      variantID: $(this).parents('[data-cart-item]').data('variant-id'),
  ...
  if (window.PXUTheme.theme_settings.cart_action === 'ajax') {
    $(document).on(w3elem, '.ajax-submit', function (e) {
      e.preventDefault();
