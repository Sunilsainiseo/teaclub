...
window.usePageDots = window.PXUTheme.theme_settings.page_dots_enabled;
 ...
 window.imageFunctions = {
  ...
  linkGalleryAndCarousel: function($gallery, $carousel){
    ...
    $carousel.on( w3elem, '.gallery-cell', function() {
...
var enableLoadMoreButton = function(parentClass) {
  ...
  $('body').on(w3elem, '[data-load-more]', function (e) {
...
window.predictiveSearch = {
  init() {
    ...
    this.forms.forEach(form => {
      ...
      this.events.register(document.body, w3elem, e => {
...
window.mobileSearch = {
  init() {
    ...
    this.events.register(this.closeEl, w3elem, () => this.close());
...
window.siteOverlay = {
  init() {
    ...
    this.events.register(this.el, w3elem, () => this.close());
...
window.sidebarAccordions = {
  init: function() {
    ...
    sidebarBlocks.forEach(block => {
      ...
      summary.addEventListener(w3elem, e => {
        e.preventDefault();
...
window.utils = {
  createAccordion: function(container, tab, content){
    ...
    $(specificTab).on(w3elem, function(e) {
      e.preventDefault();
  ...
  initializeTabs: function(){
    ...
    $('body').on(w3elem, 'ul.tabs > li > a', function(e) {
      e.preventDefault();
...
window.quickShop = {
  init: function(){
    ...
    $('body').on(w3elem, '.js-quick-shop-link', e => {
      e.preventDefault();
